# Contributing to mssql-dacpac-cicd

CI/CD pipeline for SQL Server database projects: DACPAC build, Flyway migrations, policy gates, and staged promotion.
...
```bash
git clone https://github.com/Bugzbaggy/mssql-dacpac-cicd.git
cd mssql-dacpac-cicd
```
