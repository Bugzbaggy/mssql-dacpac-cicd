<#
.Synopsis
   Continuous Deployment (CD) using dbForge DevOps Automation PowerShell for SQL Server
.DESCRIPTION
   This CD process deploys migration scripts from test database to target staging database/s.
   Renz Bagasbas
   February 08, 2024
#>
...
$database = 'AppDb_Analytics_STG'
$isWindowsAuthentication = $False
$rootFolder = "C:\Jenkins\workspace"
$databasesTxtPath = "C:\CICD\Migration\AppDb_Analytics\TargetConnection\OldSTG.txt"
